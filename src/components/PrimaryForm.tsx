...
const PrimaryForm: FunctionComponent<PrimaryFormProps> = ({ propertyData }) => {
  ...
  const queryKey = propertyData
    ? ["timelines", propertyData?.propertyId]
    : [session?.user?.email, "propertyTimelines"];
                  ...
                  return (
                    <div key={idx}>
                      ...
                      <input
                        ...
                        placeholder="Add a text to this photo"
                        type="text"
                        onChange={(event) =>
                          handleCaptionChange(
                            event,
